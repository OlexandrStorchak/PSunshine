...
public class TestFetchWeatherTask extends AndroidTestCase{
    ...
    public void testAddLocation() {
        ...
        getContext().getContentResolver().delete(Contract.LocationEntry.CONTENT_URI,
                Contract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?",
                new String[]{ADD_LOCATION_SETTING});

        FetchForecast fwt = new FetchForecast(getContext(), null);
        ...
        for ( int i = 0; i < 2; i++ ) {
            ...
            Cursor locationCursor = getContext().getContentResolver().query(
                    ...
                    new String[]{
                            ...
                            Contract.LocationEntry.COLUMN_LOCATION_SETTING,
                            Contract.LocationEntry.COLUMN_CITY,
        ...
        getContext().getContentResolver().
                acquireContentProviderClient(Contract.LocationEntry.CONTENT_URI).
