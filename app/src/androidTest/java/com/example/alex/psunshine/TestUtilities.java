...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createNorthPoleLocationValues() {
        ...
        testValues.put(Contract.LocationEntry.COLUMN_CITY, "North Pole");
        testValues.put(Contract.LocationEntry.COLUMN_LATITUDE, 64.7488);
        testValues.put(Contract.LocationEntry.COLUMN_LONGTITUDE, -147.353);
